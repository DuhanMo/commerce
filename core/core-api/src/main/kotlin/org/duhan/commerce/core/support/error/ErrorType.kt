...
enum class ErrorType(val status: HttpStatus, val code: ErrorCode, val message: String, val logLevel: LogLevel) {
    ...
    ACCESS_DENIED(HttpStatus.FORBIDDEN, ErrorCode.E403, "권한이 없습니다.", LogLevel.ERROR),
    NOT_FOUND_DATA(HttpStatus.BAD_REQUEST, ErrorCode.E404, "해당 데이터를 찾을 수 없습니다.", LogLevel.ERROR),
}
