package org.duhan.commerce.core.support.auth

import jakarta.servlet.http.HttpServletRequest
import org.duhan.commerce.core.domain.User
...
class UserArgumentResolver : HandlerMethodArgumentResolver {
    ...
    override fun resolveArgument(parameter: MethodParameter, mavContainer: ModelAndViewContainer?, webRequest: NativeWebRequest, binderFactory: WebDataBinderFactory?): User {
         ...
         */
        val userId = request.getHeader("Duhan-Commerce-User-Id") ?: throw CoreException(ErrorType.INVALID_REQUEST)
